...
class search_page:
    ...
    def __init__(self, top=None):
        ...
        self.Button_searchpage.configure(command=self.searchFlight)
        ...
        self.Entry_date = DateEntry(
            selectmode='day', background="darkturquoise")
    ...
    def searchFlight(self):
        ...
        Flightpage_support.main(source,destination,date)
